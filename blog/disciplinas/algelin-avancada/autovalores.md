...
${\textsf{\color{orange}0}}$, ${\textsf{\color{lime}1}}$ e ${\textsf{\color{blue}2}}$ que,
como veremos, constituem uma boa escolha para o nosso alfabeto $X$, e
consideramos o observável
$\varphi : [0,1]\to\{\textsf{\color{orange}0}{},\textsf{\color{lime}1},\textsf{\color{blue}2}{}\}$
...
A medida invariante mais natural no intervalo $[0,1]$ para a
...
$x_i\in\{\textsf{\color{orange}0}{},\textsf{\color{lime}1},\textsf{\color{blue}2}{}\}$
